...
class WatchListReactiveController {
    ...
    @Get(produces = MediaType.APPLICATION_JSON ) // Optional since default, for demo purpose
    ...
    @Get(
            value = '/single',
            produces = MediaType.APPLICATION_JSON // Optional since default, for demo purpose
    )
    ...
    ) // Optional since default, for demo purpose
